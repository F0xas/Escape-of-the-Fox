...
public class MazeActivity3 extends AppCompatActivity {

    private AlertDialog settingsDialog;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_maze_level_3);
    ...
    private void showSettingsDialog() {
        ...
        mainContainer.setGravity(Gravity.CENTER_HORIZONTAL); // тільки по горизонталі
        mainContainer.setPadding(40, 40, 40, 40);
        mainContainer.addView(titleView);

        float scale = getResources().getDisplayMetrics().density;
        int buttonHeightDp = 55; // Висота кнопки (більше)
        int marginPx = (int) (1 * scale); // Відступи 5 пікселів
